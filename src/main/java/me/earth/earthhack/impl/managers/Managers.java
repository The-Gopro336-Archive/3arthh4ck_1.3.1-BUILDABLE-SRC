...
public class Managers {
    ...
    public static void load() {
        ...
        Managers.subscribe(TIMER, CONNECT, CHAT, COMBAT, POSITION, ROTATION, SERVER, ACTION, SPEED, SWITCH, TPS, HOLES, SAFETY, KEYBOARD, COLOR, WRAP, MACRO, NCP, SET_DEAD, BLOCKS, ENTITIES, HEALTH, TICK, new NoMotionUpdateService(), new PotionService());
