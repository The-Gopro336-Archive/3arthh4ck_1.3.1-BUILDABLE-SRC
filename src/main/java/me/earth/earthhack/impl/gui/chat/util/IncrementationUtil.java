...
public class IncrementationUtil {
    ...
    public static String crD(String d, String min, String max, boolean de) {
        ...
        if (Keyboard.isKeyDown(29)) {
            ...
            incr = Keyboard.isKeyDown(56) ? new BigDecimal(de ? "-10.0" : "10.0") : new BigDecimal(de ? "-0.1" : "0.1");
        }
    ...
    public static long crL(long l, long min, long max, boolean de) {
        ...
        if (Keyboard.isKeyDown(29)) {
            long diff = max - min;
            incr = Keyboard.isKeyDown(56) ? diff / 10L : diff / 5L;
        } else {
            incr = Keyboard.isKeyDown(56) ? 10L : 1L;
        }
