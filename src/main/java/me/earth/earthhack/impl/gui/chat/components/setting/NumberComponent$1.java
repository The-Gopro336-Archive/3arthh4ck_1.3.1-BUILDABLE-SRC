...
class NumberComponent$1
extends SmartClickEvent {
    final Module val$module;
    final NumberSetting val$setting;

    NumberComponent$1(ClickEvent.Action theAction, Module module, NumberSetting numberSetting) {
    ...
    public String getValue() {
        return Commands.getPrefix() + "hiddensetting " + this.val$module.getName() + " \"" + this.val$setting.getName() + "\" " + NumberComponent.this.getNewValue(true);
    }
}
