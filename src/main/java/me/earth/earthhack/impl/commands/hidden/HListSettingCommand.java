...
CommandScheduler {
    ...
    private static void sendSettings(Module module) {
        ...
        Managers.CHAT.sendDeleteComponent(new TextComponentString(module.getName() + " : " + "\u00a77" + module.getCategory().toString()).setStyle(new Style().setHoverEvent(ChatComponentUtil.setOffset(new HoverEvent(HoverEvent.Action.SHOW_TEXT, new TextComponentString(module.getData().getDescription()))))), module.getName() + "2", 7000);
        int i = 2;
        ...
        Scheduler.getInstance().schedule(() -> mc.displayGuiScreen(new GuiChat()));
