...
extends ModuleListener<Timer, MotionUpdateEvent> {
    ...
    public void invoke(MotionUpdateEvent event) {
        if (event.getStage() == Stage.PRE) {
            if (((Timer)this.module).mode.getValue() == TimerMode.Blink && (double)(event.getPitch() - ((IEntityPlayerSP)((Object)ListenerMotion.mc.player)).getLastReportedPitch()) == 0.0 && (double)(event.getYaw() - ((IEntityPlayerSP)((Object)ListenerMotion.mc.player)).getLastReportedYaw()) == 0.0) {
