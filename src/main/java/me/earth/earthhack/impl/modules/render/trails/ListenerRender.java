...
extends ModuleListener<Trails, Render3DEvent> {
    ...
    public void invoke(Render3DEvent event) {
        for (Map.Entry<Integer, List<Trace>> entry : ((Trails)this.module).traceLists.entrySet()) {
            ...
            GL11.glColor4f(((Trails)this.module).color.getR(), ((Trails)this.module).color.getG(), ((Trails)this.module).color.getB(), MathHelper.clamp((float)((float)((double)((Trails)this.module).color.getA() - animation.getCurrent() / 255.0)), (float)0.0f, (float)255.0f));
