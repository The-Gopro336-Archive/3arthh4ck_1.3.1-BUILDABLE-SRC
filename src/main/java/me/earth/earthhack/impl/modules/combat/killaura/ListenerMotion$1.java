...
class ListenerMotion$1 {
    ...
    static {
        ...
        try {
            ListenerMotion$1.$SwitchMap$me$earth$earthhack$impl$modules$combat$killaura$util$AuraTeleport[AuraTeleport.Smart.ordinal()] = 1;
        }
        catch (NoSuchFieldError noSuchFieldError) {
            // empty catch block
        }
        try {
            ListenerMotion$1.$SwitchMap$me$earth$earthhack$impl$modules$combat$killaura$util$AuraTeleport[AuraTeleport.Full.ordinal()] = 2;
        }
        catch (NoSuchFieldError noSuchFieldError) {
            // empty catch block
        }
