...
extends BasicButtonUI {
    ...
    static boolean isBorderlessButton(Component c) {
        return c instanceof AbstractButton && FlatClientProperties.clientPropertyEquals((AbstractButton)c, "JButton.buttonType", "borderless");
    }
    ...
    protected void paintBackground(Graphics g, JComponent c) {
        ...
        try {
            ...
            if (!(shadowColor == null || this.shadowWidth <= 0 || !(focusWidth > 0.0f) || !c.isEnabled() || isToolBarButton || FlatButtonUI.isBorderlessButton(c) || FlatButtonUI.isFocusPainted(c) && FlatUIUtils.isPermanentFocusOwner(c))) {
    ...
    protected Color getForeground(JComponent c) {
        ...
        if (((AbstractButton)c).isSelected() && !FlatButtonUI.isToolBarButton(c) && !FlatButtonUI.isBorderlessButton(c)) {
