...
class UIDefaultsLoader {
        ...
        try {
            ...
            for (int i = 0; i < size; ++i) {
                ...
                if (source instanceof String && i + 1 < size) {
                    ...
                    for (Class<?> lafClass : lafClasses) {
                        void var12_36;
                        String propertiesName = string2 + '/' + lafClass.getSimpleName() + ".properties";
                        InputStream in = var12_36.getResourceAsStream(propertiesName);
                        try {
                            if (in == null) continue;
                            properties.load(in);
                        }
    ...
    private static Object parseColorFunctions(String value, Function<String, String> resolver, boolean reportError) {
        ...
        try {
            switch (function) {
                case "rgb": {
                    ColorUIResource colorUIResource = UIDefaultsLoader.parseColorRgbOrRgba(false, params, resolver, reportError);
                    return colorUIResource;
                }
                case "rgba": {
                    ColorUIResource colorUIResource = UIDefaultsLoader.parseColorRgbOrRgba(true, params, resolver, reportError);
                    return colorUIResource;
                }
                case "hsl": {
                ...
                case "lighten": {
                    Object object = UIDefaultsLoader.parseColorHSLIncreaseDecrease(2, true, params, resolver, reportError);
                    return object;
                }
                case "darken": {
                    Object object = UIDefaultsLoader.parseColorHSLIncreaseDecrease(2, false, params, resolver, reportError);
                    return object;
                }
                case "saturate": {
                    Object object = UIDefaultsLoader.parseColorHSLIncreaseDecrease(1, true, params, resolver, reportError);
                    return object;
                }
                case "desaturate": {
                    Object object = UIDefaultsLoader.parseColorHSLIncreaseDecrease(1, false, params, resolver, reportError);
                    return object;
                }
                case "fadein": {
                    Object object = UIDefaultsLoader.parseColorHSLIncreaseDecrease(3, true, params, resolver, reportError);
                    return object;
                }
                case "fadeout": {
                    Object object = UIDefaultsLoader.parseColorHSLIncreaseDecrease(3, false, params, resolver, reportError);
                    return object;
                }
                case "fade": {
                    Object object = UIDefaultsLoader.parseColorFade(params, resolver, reportError);
                    return object;
                }
                case "spin": {
                    Object object = UIDefaultsLoader.parseColorSpin(params, resolver, reportError);
                    return object;
                }
            }
